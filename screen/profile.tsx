        ...
        <ScrollView className="flex-1" contentContainerStyle={{ paddingVertical: 12 }}>
          ...
          <View className="mt-5 rounded-xl bg-white p-4 shadow">
            ...
            <View className="gap-3">
              <TextInput defaultValue={data.profile.name} placeholder="Full name" className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" />
              <TextInput defaultValue={data.profile.email} keyboardType="email-address" placeholder="Email" className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" />
              <TextInput defaultValue={data.profile.phone} keyboardType="phone-pad" placeholder="Phone" className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" />
            </View>
